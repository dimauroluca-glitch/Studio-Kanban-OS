const CACHE_NAME = 'studio-kanban-v28-visibility-fix';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=27.0',
...
// GESTORE SVEGLIA LOCALE BACKGROUND: Si attiva anche ad app chiusa o schermo spento
    ...
    if (delay > 0) {
      setTimeout(() => {
        self.registration.showNotification("🚨 Scadenza Domani!", {
          body: `Ricordati che domani scade il compito di: ${task.title}.`,
          tag: task.id,
          renotify: true
        });
      }, delay);
